...
const T = {
  ...
  // Home
  "Canlı piyasa takibi": { tr: "Canlı piyasa takibi", en: "Live data monitoring", el: "Παρακολούθηση δεδομένων σε πραγματικό χρόνο" },
  "Canlı piyasa takibi": { tr: "Canlı piyasa takibi", en: "Live data monitoring", el: "Παρακολούθηση δεδομένων σε πραγματικό χρόνο" },
  ...
  "Piyasaları tek ekrandan takip et.": { tr: "Piyasaları tek ekrandan takip et.", en: "Track global markets and weather from one dark dashboard.", el: "Παρακολούθησε τις παγκόσμιες αγορές και τον καιρό από έναν ενιαίο σκοτεινό πίνακα ελέγχου." },
  "Döviz, kripto, altın, portföy ve önemli piyasa gelişmelerini tek kontrol merkezinden izle.": { tr: "Döviz, kripto, altın, portföy ve önemli piyasa gelişmelerini tek kontrol merkezinden izle.", en: "Exchange rates, crypto market signals, gold prices, a 7-day global weather forecast and your favorites come together in one premium dashboard.", el: "Οι συναλλαγματικές ισοτιμίες, τα σήματα της αγοράς κρυπτονομισμάτων, οι τιμές χρυσού, η παγκόσμια πρόγνωση καιρού 7 ημερών και η λίστα αγαπημένων συγκεντρώνονται σε έναν ενιαίο προηγμένο πίνακα ελέγχου." },
  "Piyasaları aç": { tr: "Dövizleri takip et", en: "Track exchange rates", el: "Παρακολούθηση ισοτιμιών" },
  "Takip listemi oluştur": { tr: "Takip listemi oluştur", en: "Open crypto panel", el: "Άνοιγμα πίνακα κρυπτονομισμάτων" },
  "Hava durumunu gör": { tr: "Hava durumunu gör", en: "Open weather radar", el: "Άνοιγμα μετεωρολογικού ραντάρ" },
